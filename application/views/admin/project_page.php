        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <?php if(isset($bannerdetails) && count($bannerdetails) != 0){ ?>
                <form role="form" method="post" action="<?=base_url('admin/uploadeditprojectsdetails')?>" enctype="multipart/form-data">
            ...
            <?php }else{ ?>
                <form role="form" method="post" action="<?=base_url('admin/uploadprojectsdetails')?>" enctype="multipart/form-data">
                  <div class="box-body">
                    <div class="col-md-4 form-group">
