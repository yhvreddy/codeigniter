        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Upload Blog Details</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <?php if(isset($bannerdetails) && count($bannerdetails) != 0){ ?>
                <form role="form" method="post" action="<?=base_url('admin/uploadeditblogdetails')?>" enctype="multipart/form-data">
            ...
            <?php }else{ ?>
                <form role="form" method="post" action="<?=base_url('admin/uploadblogdetails')?>" enctype="multipart/form-data">
                  <div class="box-body">
                    <div class="col-md-4 form-group">
                        <label for="bannertitle">Title <span class="text-danger">*</span></label>
				  ...
				  <tbody>
					<?php $i = 1; foreach ($gallery as $key => $banner) { ?>
					  <tr>
						...
						<td>
						  <a href="<?=base_url('admin/projects/'.$banner->id.'/edit')?>" onclick="return confirm('Are you sure to edit gallery details..?')"><i class="fa fa-edit"></i></a>&nbsp;
						  <a href="<?=base_url('admin/projects/'.$banner->id.'/delete')?>" onclick="return confirm('Are you sure to delete gallery details..?')"><i class="fa fa-trash-o"></i></a>
						</td>
					  </tr>
					<?php } ?>
				  </tbody>
